...
Alongside that, you're welcome (and indeed, encouraged) to ask organisations for further support to help offset the ticket costs. It can be useful to have these additional sponsors pay for specific event expenses, such as:

- transport (coaches / trains / minibuses to and from the airport)
- diversity tickets
- a coffee van or barista
