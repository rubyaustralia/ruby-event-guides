...
If you've got a venue and dates confirmed, then it's time to start spreading the word. You'll likely want a website for the retreat itself, plus an updated listing on [Rails.Camp](http://railscamps.com), and then you can start spreading the word through mailing lists, social media, meetups, etc.

### Website

Once you've got the dates locked down for the venue, it's time to get a basic website up. Initially it should outline the date, location, and Ruby Australia's [Code of Conduct](https://ruby.org.au/policies/code-of-conduct).
