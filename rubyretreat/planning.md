...
Get some numbers into a spreadsheet (perhaps copied off a previous event's budget), and spend some time understanding the amount of funds required for such an event, and especially what the minimum numbers are to break even.
...
Numbers vary for Retreats for a variety of reasons - the location, the dates, people's interests changing, etc. Pre-COVID, it was not unexpected for a camp to have 100+ attendees, but excellent events have been run with 50 attendees. It's recommended you opt for a modest number as part of your planning for breaking even (and previous organisers can help suggest what that might be).
